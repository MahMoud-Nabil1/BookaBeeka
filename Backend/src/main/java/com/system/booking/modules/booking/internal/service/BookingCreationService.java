...
public class BookingCreationService {
    ...
    public BookingConfirmationDto createBooking(CreateBookingRequestDto request, String idempotencyKey) {
        ...
        // step 2: check if the slot is actually free
        ...
        // step 5: consume the lock so it can't be reused
        ...
        // step 6: save the idempotency response for future replays
        ...
        // step 7: fire the event (listeners run after commit)
